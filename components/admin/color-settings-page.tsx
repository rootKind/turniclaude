...
const COLOR_GROUPS: { label: string; tokens: string[] }[] = [
  ...
  { label: 'Chip / Sala',         tokens: ['--chip-selected-bg','--chip-selected-text','--chip-selected-border','--desk-schedule-border','--sala-highlight-border','--sala-highlight-ring','--sala-own-badge-bg','--sala-own-badge-border','--sala-own-badge-text','--sala-present-pill-bg','--sala-present-pill-text','--sala-toolbar-chip-bg','--sala-toolbar-chip-text','--sala-toolbar-chip-border','--sala-toolbar-nav-bg','--sala-toolbar-nav-border','--sala-toolbar-nav-text'] },
  { label: 'Sala card',           tokens: ['--sala-card-bg','--sala-card-border','--sala-card-title-bg','--sala-card-body-bg','--sala-card-tir-bg'] },
